...
#   coverage-<foo>  Κάνει compile και εκτελεί το <foo>, και παράγει coverage report
#
...
#   coverage        Εκτελεί το run, και παράγει ένα ενιαίο coverage report
...
#	-Wextra	   Ενεργοποιεί επιπλέον warnings
...
#			   , το οποίο συμπεριλαμβάνει όλα τα header files που γίνονται include
#
